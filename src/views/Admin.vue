...
<!--create dialog for new user-->
  <md-dialog :md-active.sync="showDialog">
          ...
          <div class="md-dialog-content md-layout">      
             <div class="md-layout-item" style="width:600px">
                 <md-field>
                     ...
                     <md-input type="text" v-model="selectedUser.userName"></md-input>
                 </md-field>
                 <md-field class="md-layout-item" >
                       <label>Password</label>
                       <md-input type="password" v-model="selectedUser.password"></md-input>
                  </md-field>
                  <md-field class="md-layout-item" >
       ...
       <md-dialog-title>Update Information</md-dialog-title>
         ...
         <div style="padding-left: 13px">  <md-checkbox v-model="editStatusName" class="md-primary">Active/Inactive</md-checkbox></div>
        <md-dialog-actions>
          <md-button class="md-primary" @click="cancelDialog">Cancel</md-button>
